...
class YOLODetection:
    ...
    def stream_video_with_detections_and_sort(self, rtsp_url, frame, height, width, fps):

        self.start_ffplay(rtsp_url)
        self.start_ffmpeg(rtsp_url, height, width, fps)
    ...
    def start_ffmpeg(self, rtsp_url, height, width, fps):
        ...
        command = [
            ...
            '-bsf:v', 'dump_extra', '-hide_banner', '-loglevel', 'error', rtsp_url
        ]
    ...
    def create_zone():
        road_zoneA = np.array([[424, 350], [597, 354], [517, 639], [47, 585], [424,585]], np.int32)
